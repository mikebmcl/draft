...
\ref{span}                  & Spans                            & \tcode{<span>} \\ \rowsep
\end{libsumtab}
...
\rSec1[span]{Class template \tcode{span}}
...
A \tcode{span} type is a view over a contiguous sequence of objects,
...
\rSec2[span.cons]{Constructors, copy, and assignment}
...
\rSec2[span.elem]{Element access}
...
\rSec2[span.iterators]{Iterator support}
...
\rSec2[span.objectrep]{Views of object representation}
...
\rSec2[span.tuple]{Tuple interface}
